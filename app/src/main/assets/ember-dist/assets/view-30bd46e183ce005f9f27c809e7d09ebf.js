...
r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(e):void 0})}function v(e,t){return t.reduce(((e,t)=>t(e)||e),e)}function g(e,t){for(let[r,i,n]of t)"field"===r?h(e,i,n):b(e,i,n)
...
function w(){const e={},t=[],r=(0,u.recordIdentifierFor)(this),i=this.store.schema.fields(r),n={name:"Attributes",properties:["id"],expand:!0},o=n.properties,a=[n]
for(const u of i.values())switch(u.kind){case"attribute":o.push(u.name)
break
case"belongsTo":case"hasMany":{let r=e[u.kind]
void 0===r&&(r=e[u.kind]=[],a.push({name:u.kind,properties:r,expand:!0})),r.push(u.name),t.push(u.name)
...
class j extends r.default{constructor(...e){super(...e),s(this,P,void m(this,"store"))}getFilters(){return[{name:"isNew",desc:"New"},{name:"isModified",desc:"Modified"},{name:"isClean",desc:"Clean"}]}_nameToClass(e){return this.store.modelFor(e)}watchModelTypes(e,t){const{store:r}=this,i=function(e){let t=y.get(e)
...
const u=this.wrapModelType(a,r)
o.push(this.observeModelType(r,n)),i([u]),t.set(r,!0)}}columnNameToDesc(e){return(0,a.capitalize)((0,a.underscore)(e).replace(/_/g," ").trim())}columnsForType(e){const t=[{name:"id",desc:"Id"}]
let r=0
...
let o=t.versionOnly||t.hideSha,a=t.shaOnly||t.hideVersion,u=null
return o&&(t.showExtended&&(u=n.match(i.versionExtendedRegExp)),u||(u=n.match(i.versionRegExp))),a&&(u=n.match(i.shaRegExp)),u?u[0]:n}Object.defineProperty(e,"__esModule",{value:!0}),e.appVersion=n,e.default=void 0
